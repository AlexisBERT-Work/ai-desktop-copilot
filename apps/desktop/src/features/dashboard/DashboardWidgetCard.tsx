...
import { MAX_W } from './dashboardStore';
...
export function DashboardWidgetCard({
  ...
  const { removeWidget, renameWidget, cycleWidgetWidth, cycleWidgetHeight } = useDashboardStore();
  ...
  return (
    ...
    >
      ...
      <div className="mb-2 flex items-center gap-1">
        {editMode && (
          <GripVertical
            className="h-3.5 w-3.5 shrink-0 cursor-grab text-white/25"
            aria-hidden
          />
        )}
