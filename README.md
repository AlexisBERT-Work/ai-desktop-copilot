...
- Semantic memory (Ollama embeddings + cosine vector store, JSON persistence)
...
║  │  Ollama │ SQLite/JSON │ Tesseract │ WinAPI/PowerShell      │  ║
║  └──────────────────────────────────────────────────────────┘   ║
╚══════════════════════════════════════════════════════════════════╝
```
...
| Vector store  | **Maison (cosinus + JSON)**     | Embeddings Ollama, zéro dépendance native    |
...
│   │       ├── memory/             # SQLite conversations, vector store (cosinus)
